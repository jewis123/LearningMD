通过之前的[shader初识](http://www.jianshu.com/p/c9839f79f448)，Fixed Function Shader是固定功能的着色器，它的功能有限，但是编写比较简单，因为它总是通过一系列的命令达到我们对图形着色的目的。现在我们来看一段脚本
```
...
![实现的效果](http://upload-images.jianshu.io/upload_images/3806085-64059d554ae8915a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

更多语法，详看[ShaderLab syntax](https://docs.unity3d.com/Manual/SL-Shader.html)