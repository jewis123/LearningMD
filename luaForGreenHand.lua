...
--E.G.
  for word in string .gmatch("Hello Lua user","%a+")   --%a+ 是什么鬼？往下看，这是匹配模式
     do  print(word)
  end
  print('-----------------------------')
...
--[[          秀出一波table的操作  [, XXX]  表示可选参数
   ...
   1. table.concat(table[,sep[,start[,end]]  --连接从start~end的字符，以sep隔开
-- 2. table.insert(talbe,[pos,]value)          --在指定位置pos插入一个value的值，默认在数组末尾
...
tablestring = setmetatable({1,2,3},{
